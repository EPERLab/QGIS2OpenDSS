...
def renameVoltage(MVCode, LVCode): #Para monofasicos, tension L-N, para trifasicos tension L-L
        ...
        if MVCode == 380:
            ...
            MV = {'LN': 14.38, 'LL': 24.9}
        elif MVCode == 330: ######### PERÚ
            MV = {'LN': 13.22, 'LL': 22.9}
        elif MVCode == 270:
            MV = {'LN': 7.97,'LL': 13.8}   
        elif MVCode == 230:
            MV = {'LN': 7.62, 'LL': 13.2} 
        elif MVCode == 200: ######### PERÚ
            MV = {'LN': 10.5, 'LL': 10.5} 
        elif MVCode == 150:
            MV = {'LN': 7.2, 'LL': 7.2}
        elif MVCode == 120:
        ...
        if LVCode == 70:
            ...
            LV = {'LN': 0.44, 'LL': 0.44} #Conexión delta 3 conductores PERU
        elif LVCode == 50:
            LV = {'LN': 0.277, 'LL': 0.48}    
        elif LVCode == 40:
            LV = {'LN': 0.240, 'LL': 0.48}
...
react_list1F3W={ # List of reactances for single phase three winding transformers
            ...
            '22.9':{
                '0.22': {
                    '3': 'Xhl=1.31 Xht=1.31 Xlt=0.87',
                    '5': 'Xhl=1.31 Xht=1.31 Xlt=0.87',
                    '8': 'Xhl=1.4 Xht=1.4 Xlt=0.94',
                    '10': 'Xhl=1.4 Xht=1.4 Xlt=0.94',
                    '13': 'Xhl=1.19 Xht=1.19 Xlt=0.79',
                    '15': 'Xhl=1.19 Xht=1.19 Xlt=0.79',
                    '20': 'Xhl=1.49 Xht=1.49 Xlt=0.99',
                    '25': 'Xhl=1.49 Xht=1.49 Xlt=0.99',
                    '37': 'Xhl=1.7 Xht=1.7 Xlt=1.14',
                    '40': 'Xhl=1.7 Xht=1.7 Xlt=1.14',
                    '50': 'Xhl=1.86 Xht=1.86 Xlt=1.24',
                    '75': 'Xhl=1.8 Xht=1.8 Xlt=1.2',
                    '80': 'Xhl=1.8 Xht=1.8 Xlt=1.2',
                    '100': 'Xhl=1.94 Xht=1.94 Xlt=1.3',
                    '160': 'Xhl=2.15 Xht=2.15 Xlt=1.43',
                    '167': 'Xhl=2.15 Xht=2.15 Xlt=1.43',
                    '250': 'Xhl=2.69 Xht=2.69 Xlt=1.79',
                    '333': 'Xhl=2.66 Xht=2.66 Xlt=1.78',
                    '500': 'Xhl=2.76 Xht=2.76 Xlt=1.84'}},
...
res_list1F3W={ # List of resistances for single phase three winding transformers
            ...
            '22.9':{
                '0.22':{
                    ...
                    '13': '%Rs=[0.88 1.77 1.77]',
                    '15': '%Rs=[0.88 1.77 1.77]',
                    '20': '%Rs=[0.77 1.54 1.54]',
                    '25': '%Rs=[0.77 1.54 1.54]',
                    '40': '%Rs=[0.68 1.35 1.35] ',
                    '50': '%Rs=[0.68 1.35 1.35] ',
                    '75': '%Rs=[0.60 1.20 1.20]',
                    '80': '%Rs=[0.60 1.20 1.20]',
                    '100': '%Rs=[0.55 1.11 1.11]',
                    '160': '%Rs=[0.55 1.11 1.11]',                
...
imp_list1F_mv_mv={ # List of impedances for single phase two winding transformers [MV][MV][Power]
            '13.8':{
                    '2.4':{}},
...
imp_list3F={
		...
		'4.16':{
            ...
            '10.5':{ #PERU
                '5': 'Xhl=4 %Rs=[1.82 1.82]', 
                '10': 'Xhl=4 %Rs=[1.56 1.56]',
                '15': 'Xhl=4 %Rs=[1.5 1.5]', 
                '25': 'Xhl=4 %Rs=[1.19 1.19]',
                '37.5': 'Xhl=4 %Rs=[1.15 1.15]',
                '50': 'Xhl=4 %Rs=[1.12 1.12]',
                '75': 'Xhl=4 %Rs=[1.01 1.01]',
                '100': 'Xhl=4 %Rs=[0.96 0.96]',
                '125': 'Xhl=4 %Rs=[0.90 0.90]', 
                '160': 'Xhl=4 %Rs=[0.87 0.87]',
                '200': 'Xhl=4 %Rs=[0.84 0.84]',
                '250': 'Xhl=4 %Rs=[0.76 0.76]',
                '315': 'Xhl=4 %Rs=[0.72 0.72]',  
                '400': 'Xhl=4 %Rs=[0.69 0.69]',
                '500': 'Xhl=4 %Rs=[0.65 0.65]',
                '630': 'Xhl=4 %Rs=[0.64 0.64]'},
            ...
            '22.9':{ ##Perú -> POR CORREGIR
                '5': 'Xhl=2.84 %Rs=[1.03 1.03]',
                '9': 'Xhl=2.84 %Rs=[1.03 1.03]',
                '10': 'Xhl=2.84 %Rs=[1.03 1.03]',
                '15': 'Xhl=2.28 %Rs=[0.88 0.88]', 
                '25': 'Xhl=2.28 %Rs=[0.88 0.88]',                
                '30': 'Xhl=2.28 %Rs=[0.88 0.88]',
                '38': 'Xhl=2.08 %Rs=[0.81 0.81]',
                '40': 'Xhl=2.08 %Rs=[0.81 0.81]',
                '45': 'Xhl=2.08 %Rs=[0.81 0.81]',
                '50': 'Xhl=2.08 %Rs=[0.81 0.81]',
                '75': 'Xhl=1.65 %Rs=[0.72 0.72]',
                '80': 'Xhl=1.65 %Rs=[0.72 0.72]',
                '100': 'Xhl=1.30 %Rs=[0.63 0.63]',
                '112': 'Xhl=1.30 %Rs=[0.63 0.63]',
                '115': 'Xhl=1.30 %Rs=[0.63 0.63]',
                '125': 'Xhl=1.30 %Rs=[0.63 0.63]',
                '150': 'Xhl=1.55 %Rs=[0.60 0.60]',
                '160': 'Xhl=1.55 %Rs=[0.60 0.60]',
                '200': 'Xhl=1.55 %Rs=[0.55 0.55]', 
                '225': 'Xhl=1.55 %Rs=[0.55 0.55]', 
                '250': 'Xhl=1.55 %Rs=[0.55 0.55]',
                '300': 'Xhl=1.67 %Rs=[0.52 0.52]',
                '320': 'Xhl=1.67 %Rs=[0.52 0.52]',
                '400': 'Xhl=2.07 %Rs=[0.50 0.50]',
                '500': 'Xhl=2.07 %Rs=[0.50 0.50]',
                '750': 'Xhl=5.59 %Rs=[0.48 0.48]',
...
noloadloss_list3F={ '5': '%noloadloss=0.94',
                    '9': '%noloadloss=0.94',
                    '10': '%noloadloss=0.76',
                    '15': '%noloadloss=0.71',
                    '25': '%noloadloss=0.58',
